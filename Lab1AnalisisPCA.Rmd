...
Podemos observar que se han creado 5,019,325 reglas de asociación. Estas logran identificar relaciones raras o imperceptibles a simple vista en nuestro set de datos, y, tomando en cuenta la gran cantidad de datos con los que se cuenta a pesar de haber trabajado únicamente con las variables categóricas, tiene sentido la cantidad de reglas que han sido generadas.
